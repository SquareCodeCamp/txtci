...
class SponsorsControllerTest < ActionController::TestCase
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post :create, sponsor: { child_id: @sponsor.child_id, location: @sponsor.location, name: @sponsor.name, sponsor_id: @sponsor.sponsor_id }
    end
  ...
  test "should update sponsor" do
    patch :update, id: @sponsor, sponsor: { child_id: @sponsor.child_id, location: @sponsor.location, name: @sponsor.name, sponsor_id: @sponsor.sponsor_id }
    assert_redirected_to sponsor_path(assigns(:sponsor))
  end
