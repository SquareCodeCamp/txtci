...
class ChildrenControllerTest < ActionController::TestCase
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post :create, child: { child_id: @child.child_id, name: @child.name, sponsor_id: @child.sponsor_id }
    end
  ...
  test "should update child" do
    patch :update, id: @child, child: { child_id: @child.child_id, name: @child.name, sponsor_id: @child.sponsor_id }
    assert_redirected_to child_path(assigns(:child))
  end
